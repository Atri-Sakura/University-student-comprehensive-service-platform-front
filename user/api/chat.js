...
export const addMessage = (messageData) => {
  ...
  const data = {
    ...
    fromType: messageData.fromType || USER_TYPE.USER,
    fromId: messageData.fromId,
    toType: messageData.toType || USER_TYPE.RIDER,
    toId: messageData.toId || '1002',
...
export const updateMessage = (updateData) => {
  ...
  return request.put('/platform/chat/message', data)
}
