...
export const loginAPI = {
  student: `${baseUrl}/auth/user/login`, // 学生登录接口
  rider: `${baseUrl}/auth/rider/login`,     // 骑手登录接口
  merchant: `${baseUrl}/auth/merchant/login` // 商家登录接口
};

// 注册相关接口
export const registerAPI = {
  student: `${baseUrl}/auth/user/register`, // 学生注册接口
  rider: `${baseUrl}/auth/rider/register`,     // 骑手注册接口
  merchant: `${baseUrl}/auth/merchant/register` // 商家注册接口
};

// 用户相关接口
export const userAPI = {
  getUserInfo: `${baseUrl}/auth/api/user/info`,     // 获取用户信息
  updateUserInfo: `${baseUrl}/auth/api/user/update`, // 更新用户信息
  changePassword: `${baseUrl}/auth/api/user/change-password` // 修改密码
};
...
export const merchantOrderAPI = {
  ...
  list: `${baseUrl}/merchant/order/list`,
